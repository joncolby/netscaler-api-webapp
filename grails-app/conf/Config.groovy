...
// grails 1.3.x tries to do a call not available with Java7
...
log4j = {
    ...
    //    console name:'stdout', layout:pattern(conversionPattern: '%c{2} %m%n')
        // TODO - configure max keep files
        rollingFile name:'netscaler-webapp', maxFileSize:"500MB", file: logfile
    }
